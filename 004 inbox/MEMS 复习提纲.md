...
常压化学气相淀积（APCVD）：功率电子光电子：常压化学气相淀积可以用来沉积氧化锌（ZnO）和氮化铟镓（InGaN）等光学材料，这些材料具有良好的光学透明性和发光性，可以制造出高效的光电器件，如发光二极管、光电二极管、激光器等，广泛应用于显示、照明、通信等领域⁵⁶。
- 陶瓷：常压化学气相淀积可以用来沉积氮化硅（Si3N4）和碳化硼（B4C）等陶瓷材料，这些材料具有高硬度、高耐磨、高耐腐蚀等特性，可以制造出优良的陶瓷涂层、陶瓷刀具、陶瓷轴承等，广泛应用于机械、化工、冶金等领域 。
等离子体增强化学气相淀积（PECVD）：
分子束淀积：